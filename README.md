...
<p><strong>Note:</strong> This repository is a personal fork of <a href="https://github.com/Thysrael/Horizon">Thysrael/Horizon</a>, customized for personal use. Some changes may differ from the upstream project.</p>
